...
import Display from "@/components/dashboard/workspaceId/works/new/Display";
...
export default async function NewWorkPage({ params }) {
  ...
  return (
    <Display
      ...
      createWork={createWork.bind(null, workspaceId)}
      locale={locale}
    />
  );
}
